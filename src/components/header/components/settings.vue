    ...
    <n-drawer-content :title="$t('setting')" :native-scrollbar="false" closable>
      <n-tabs type="segment" default-value="style" animated>
        <n-tab-pane name="style" :tab="$t('setting_style') + '🫠'">
          ...
          <n-form label-align="left" label-placement="left" label-width="auto">
            ...
            <n-form-item path="align" :label="$t('fullscreen')">
              <n-switch
                v-model:value="settingFullscreen"
                size="medium"
                :checked-value="true"
          ...
          <n-form label-align="left" label-placement="left" label-width="auto">
            <n-form-item :label="$t('primary_color')">
              <n-color-picker
                v-model:value="configs.overridesPrimaryColor"
                size="medium"
              />
            </n-form-item>
            <n-form-item :label="$t('primary_color_hover')">
              <n-color-picker
                v-model:value="configs.overridesPrimaryColorHover"
                size="medium"
              />
            </n-form-item>
            <n-form-item :label="$t('primary_color_pressed')">
              <n-color-picker
                v-model:value="configs.overridesPrimaryColorPressed"
                size="medium"
              />
            </n-form-item>
          </n-form>
          <div class="font-bold font-size-4 my-2">
            {{ $t('setting_title_gradient') + '🥸' }}
          </div>
          <n-form label-align="left" label-placement="left" label-width="auto">
            <n-form-item path="align" :label="$t('gradient_angle')">
              <n-input-number
                v-model:value="configs.deg"
                size="medium"
                min="0"
                max="360"
                step="1"
        ...
        <n-tab-pane name="download" :tab="$t('setting_download') + '😶‍🌫️'">
          <div class="font-bold font-size-4 my-2 cursor-help">
            {{ $t('setting_plantuml') }}
          ...
          <n-form label-align="left" label-placement="left" label-width="auto">
            <n-alert
              ...
              :show-icon="false"
            >
              Do not change the default value unless you know what you are
              doing.
            </n-alert>
            <n-form-item path="align" :label="$t('server_url')">
              <n-input
                v-model:value="configs.baseUMLUrl"
                size="medium"
                :clearable="true"
              />
            </n-form-item>
          ...
          <n-form label-align="left" label-placement="left" label-width="auto">
            <n-form-item path="align" :label="$t('object_fit_contain')">
              <n-switch
                v-model:value="configs.isObjectFit"
                size="medium"
                :checked-value="true"
                :unchecked-value="false"
              >
            ...
            <n-form-item path="align" :label="$t('image_width')">
              <n-input-number
                v-model:value="configs.baseWidth"
                size="medium"
                min="0"
                step="1"
              />
            ...
            <n-form-item path="align" :label="$t('image_height')">
              <n-input-number
                v-model:value="configs.baseHeight"
                size="medium"
                min="0"
                step="1"
                :placeholder="
